  ...
  return (
    <div className="dashboard-card" style={{ padding: 16 }}>
      <div style={{display:'flex', justifyContent:'space-between', marginBottom:8}}>
        <h3 style={{ margin: 0 }}>Daily Volume</h3>
        <span style={{ fontSize: 12, color: '#6B7280' }}>Count per Date</span>
      </div>
      <div style={{ width: '100%', height: 260 }}>
        <ResponsiveContainer>
          <AreaChart data={data} margin={{ top: 8, right: 16, bottom: 8, left: 0 }}>
            ...
            <Area dataKey="count" stroke="#06B6D4" fill="url(#dv)" />
          </AreaChart>
        </ResponsiveContainer>
      </div>
    </div>
...
export default DailyVolumeArea;
